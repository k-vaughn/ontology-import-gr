...
=== "SVG (interactive)"
    ...
    <polygon fill="white" stroke="none" points="-4,4 -4,-72 180,-72 180,4 -4,4"/>
    ...
    <text xml:space="preserve" text-anchor="start" x="2" y="-29.73" font-family="Arial" font-size="12.00">DeliveryMethod</text>
...
| Class | Description |
|-------|-------------|
| [Delivery mode parcel service](DeliveryModeParcelService.md) |  |
