...
=== "SVG (interactive)"
    ...
    <g id="a_node2"><a xlink:href="../QuantitativeValueInteger" xlink:title="&lt;TABLE&gt;">
    <polygon fill="lightgray" stroke="none" points="1,-82.25 1,-98.5 155.25,-98.5 155.25,-82.25 1,-82.25"/>
    <text xml:space="preserve" text-anchor="start" x="12.88" y="-86.25" font-family="Arial" font-size="12.00">QuantitativeValueInteger</text>
    <text xml:space="preserve" text-anchor="start" x="2" y="-70" font-family="Arial" font-size="12.00">description : rdfs:Literal</text>
    <text xml:space="preserve" text-anchor="start" x="2" y="-53.75" font-family="Arial" font-size="12.00">hasMaxValueInteger : xsd:int</text>
    <text xml:space="preserve" text-anchor="start" x="2" y="-37.5" font-family="Arial" font-size="12.00">hasMinValueInteger : xsd:int</text>
    <text xml:space="preserve" text-anchor="start" x="2" y="-21.25" font-family="Arial" font-size="12.00">hasValueInteger : xsd:int</text>
...
| [hasMaxValueInteger](../properties/hasMaxValueInteger.md) | datatype xsd:int |
| [hasMinValueInteger](../properties/hasMinValueInteger.md) | datatype xsd:int |
| [hasValueInteger](../properties/hasValueInteger.md) | datatype xsd:int |
