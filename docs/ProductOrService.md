...
=== "SVG (interactive)"
    ...
    <polygon fill="white" stroke="none" points="-4,4 -4,-72 190.25,-72 190.25,4 -4,4"/>
    ...
    <text xml:space="preserve" text-anchor="start" x="2" y="-29.73" font-family="Arial" font-size="12.00">ProductOrService</text>
...
| Class | Description |
|-------|-------------|
| [Actual product or service instance (DEPRECATED)](ActualProductOrServiceInstance.md) |  |
| [Individual](Individual.md) |  |
| [Product or service model](ProductOrServiceModel.md) |  |
| [Product or services some instances placeholder (DEPRECATED)](ProductOrServicesSomeInstancesPlaceholder.md) |  |
| [Some items](SomeItems.md) |  |
